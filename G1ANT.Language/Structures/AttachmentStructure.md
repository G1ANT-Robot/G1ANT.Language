...
## Example
This example shows how to download an attachment using the [`mail.imap`](https://manual.g1ant.com/link/G1ANT.Addon.Net/G1ANT.Addon.Net/Commands/MailImapCommand.md) command and save it on the desktop:
